...
| plan-phase | Ask user in chat | Multiple valid approaches |
| plan-phase | Ask user in chat | Decision gate before writing |
| research-phase | Ask user in chat | Low confidence findings |
...
| execute-phase | Ask user in chat | Previous phase had issues |
| create-brief | Ask user in chat | Decision gate before writing |
| create-roadmap | Inline | Confirm phase breakdown |
| create-roadmap | Ask user in chat | Decision gate before writing |
...
- Ask the user in chat for yes/no
