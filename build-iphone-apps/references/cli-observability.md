...
| Task | CLI | Tool |
|------|-----|------|
| Build errors | OK | xcsift |
| Runtime logs | OK | simctl log stream |
| Crash symbolication | OK | atos, lldb |
| Breakpoints/debugging | OK | lldb |
| Memory leaks | OK | leaks, xctrace |
| CPU profiling | OK | xctrace |
| Network inspection | OK | mitmproxy |
| Test results | OK | xcresulttool |
| Accessibility audit | OK | UI tests |
| Sanitizers | OK | xcodebuild flags |
